...
**Tests**: Automated test tasks are REQUIRED. Every user story and every shared
foundation change MUST include the lowest-cost test coverage that proves the
...
- [ ] T012 [P] [US1] Unit test coverage for the core business logic in tests/unit/test_[name].py
- [ ] T013 [P] [US1] Contract or integration test for [endpoint/journey] in tests/integration/test_[name].py
- [ ] T014 [US1] Capture failing-first evidence and regression scope for the story
...
- [ ] T021 [P] [US2] Unit test coverage for the core business logic in tests/unit/test_[name].py
- [ ] T022 [P] [US2] Contract or integration test for [endpoint/journey] in tests/integration/test_[name].py
- [ ] T023 [US2] Capture failing-first evidence and regression scope for the story
...
- [ ] T028 [P] [US3] Unit test coverage for the core business logic in tests/unit/test_[name].py
- [ ] T029 [P] [US3] Contract or integration test for [endpoint/journey] in tests/integration/test_[name].py
- [ ] T030 [US3] Capture failing-first evidence and regression scope for the story
...
- [ ] TXXX Re-run quality gates across all stories
- [ ] TXXX [P] Additional regression and unit tests in tests/unit/
...
- Quality gates and regression verification before story sign-off
...
- Capture failing-first evidence and regression scope as explicit tasks, not implicit review work
